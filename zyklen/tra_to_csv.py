...
def tra_to_csv(input_directory, output_directory):
    # input_directory = 'data/cycle_vs_single_test/single_measurements/messreihe_3'
    # output_directory = '../data/cycle_vs_single_test/single_measurements/messreihe_3/cleared/'
